...
def covid19_auto_report():
    ...
    headers = {
        ...
        "User-Agent": "Mozilla/5.0 (NAMEWindows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36 MicroMessenger/7.0.9.501 NetType/WIFI MiniProgramEnv/Windows WindowsWechat",
    ...
    r = requests.post(url, headers=headers, json=config["NAME"])
    output = r.json()
    print(output["msg"])
